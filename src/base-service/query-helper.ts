...
import { IFilter, IInclude, ISort } from '../interface/interface';
...
export class QueryHelper {
  ...
  _parseFilters(filters: IFilter[]): WhereOptions {let where: WhereOptions = {};
    ...
    filters.forEach(filter => {
      ...
      switch (filter.operator.toLowerCase()) {
        case 'equals':
          ...
          break;
        case 'not_equals':
          where[filter.code] = { [Op.not]: this.getFilterValue(filterValue) };
          break;
        case 'contains':
          where[filter.code] = { [Op.like]: `%${this.getFilterValue(filterValue)}%` };
          break;
        case 'does_not_contain':
          where[filter.code] = { [Op.notLike]: `%${this.getFilterValue(filterValue)}%` };
          break;
        case 'contains_case_insensitive':
          where[filter.code] = { [Op.iLike]: `%${this.getFilterValue(filterValue)}%` };
          break;
        case 'does_not_contain_case_insensitive':
          where[filter.code] = { [Op.notILike]: `%${this.getFilterValue(filterValue)}%` };
          break;
        case 'starts_with':
          where[filter.code] = { [Op.like]: `${this.getFilterValue(filterValue)}%` };
          break;
        case 'ends_with':
          ...
          break;
        case 'in':
          where[filter.code] = { [Op.in]: this.getFilterValue(filterValue, true) };
          break;
        case 'not_in':
          where[filter.code] = { [Op.notIn]: this.getFilterValue(filterValue, true) };
          break;
        case 'is':
          where[filter.code] = { [Op.in]: this.getFilterValue(filterValue, true) };
          break;
        case 'is_not':
          ...
          break;
        case 'array_contains':
          where[filter.code] = { [Op.contains]: this.getFilterValue(filterValue, true) };
          break;
        case 'is_greater_than':
          where[filter.code] = { [Op.gte]: this.getFilterValue(filterValue) };
          break;
        case 'is_smaller_than':
          where[filter.code] = { [Op.lt]: this.getFilterValue(filterValue) };
          break;
        case 'between':
          where[filter.code] = { [Op.between]: this.getFilterValue(filterValue, true) };
          break;
        case 'or': 
          const or = {
            [Op.or]: this._parseFilters(filterValue)
          }
          where = {
            ...where,
            ...or
        ...
        case 'and':
          const and = {
            [Op.and]: this._parseFilters(filterValue)
          }
          where = {
            ...where,
            ...and
